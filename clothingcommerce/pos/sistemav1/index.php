...
<body class="bg-gradient-success superbody">
        ...
        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Sistema Punto de Venta</h1>
                                        <br>
                                        <h1 class="h4 text-gray-800 mb-2">¡ Bienvenid@s !</h1>
                                        <br><br>
                                    </div>
                                    <div id="login-form">
                                    <form id="form-login" >
                                        ...
                                        <input type="submit" name="log" value="Entrar" class="btn btn-success btn-user btn-block">
                                    </form>                               
                                  </fieldset>
                                </div>
                            </div>
          ...
          <footer class="sticky-footer bg-blue">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto -5">
                        <span>Copyright &copy; SistemasPyS 2022</span>
                    </div>
                </div>
            </footer>
