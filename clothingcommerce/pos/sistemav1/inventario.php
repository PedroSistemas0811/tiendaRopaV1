                            ...
                            <div class="card border-left-success shadow h-100 py-1">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-2 mb-3 mb-sm-0">
                                     ...
                                     <div class="col-sm-2 mb-3 mb-sm-0">
                                        <button class="btn btn-success btn-user btn-block" id="btnAddArticulo" name="btnAddArticulo">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        ...
                                        <button class="btn btn-success btn-user btn-block" id="guardarArticulo" name="guardarArticulo" onclick="funcionesArticulos.updateProducto();"><span id="texto_btnGuardar" name="texto_btnGuardar" class="texto">Guardar</span> 
