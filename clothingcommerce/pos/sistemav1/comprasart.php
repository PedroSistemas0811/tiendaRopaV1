...
<head>
  ...
  <title>Entradas - ¿Qué me Pongo?</title>
          ...
          <div class="row">
           ...
           <div class="col mr-6">
            ...
            <div class="h5 mb-1 font-weight-bold text-gray-800">
              <button  data-toggle="button" id="busquedaEntradas" aria-pressed="false" autocomplete="off" class="btn btn-success btn-sl" onclick="showAllEntradas();">Buscar
           ...
           <div class="col mr-6">
            ...
            <div class="h5 mb-1 font-weight-bold text-gray-800">
              <button  data-toggle="button" id="btn_puntoVenta" aria-pressed="false" autocomplete="off" class="btn btn-success btn-sl" onclick="gotoEntradas(true);">Nueva entrada
